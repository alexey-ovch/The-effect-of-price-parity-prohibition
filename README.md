...
Синтетический контроль создает **взвешенную комбинацию региональных юнитов** (других сицилийских регионов), которая наилучшим образом воспроизводит тренд Корсики до воздействия.
...
**Примечание**: датасеты не включены в репозиторий. Для воспроизведения анализа необходимы исходные файлы от авторов.
...
- Анализ долгосрочных эффектов (сверх октября 2015 г.)
- Оценка воздействия на объемы бронирований (demand-side эффекты)
- Анализ распределительных эффектов между отельерами и потребителями
- Сравнение эффектов для разных сегментов туризма (деловой, отдыхающие)
- Применение методов машинного обучения для идентификации гетерогенных эффектов
